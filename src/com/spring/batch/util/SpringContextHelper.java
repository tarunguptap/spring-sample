...
public class SpringContextHelper {
    ...
    public static void closeHibernateSession() {
        ...
        SessionFactoryUtils.releaseSession(sessionHolder.getSession(), threadLocalsessionFactory.get());
    ...
    public static ApplicationContext getApplicationContextForTestNg() {
        String[] configLocations = { "/applicationContext-test.xml", "/jdbcDatasourceContext.xml", "/daoContext.xml",
                "/batchContext.xml" };
        ApplicationContext applicationContext = new ClassPathXmlApplicationContext(configLocations);
        return applicationContext;
    }
